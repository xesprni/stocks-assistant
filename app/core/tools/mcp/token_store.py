...
class MCPTokenStore:
    ...
    def __init__(self, workspace_dir: str, user_id: str | None = None):
    ...
    def _save(self, data: dict[str, Any]) -> None:
        ...
        for server_name, entry in sanitized.items():
            if isinstance(entry, dict):
                get_app_store().set_mcp_oauth_entry(server_name, entry, user_id=self._user_id)
    ...
    def clear(self, server_name: str) -> None:
        ...
        with self._lock:
            ...
            get_app_store().clear_mcp_oauth_entry(server_name, user_id=self._user_id)
            self._cache = data
