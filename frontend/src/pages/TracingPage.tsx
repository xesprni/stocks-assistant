    ...
    <section className="panel motion-panel page-enter flex h-full min-h-0 min-w-0 flex-1 flex-col rounded-md">
      ...
      {!selectedSession ? (
        <div className="panel-body flex min-h-0 flex-1 flex-col gap-3 overflow-hidden">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto rounded-md border border-border/80 bg-background/35 p-1.5">
            {isSessionLoading ? (
        ...
        <div className="panel-body grid min-h-0 flex-1 gap-3 overflow-hidden xl:grid-cols-[280px_minmax(0,1fr)]">
          <div className="min-h-0 overflow-y-auto rounded-md border border-border/80 bg-background/35 p-1.5">
