  ...
  return (
    <section className="panel motion-panel page-enter flex h-full min-h-0 min-w-0 flex-1 flex-col rounded-md">
      <div className="panel-header flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <Badge variant="outline">{currentMarket.label}</Badge>
          </div>
        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <label className="flex h-7 items-center gap-2 rounded-md border border-border/70 bg-muted/40 px-2 text-xs text-muted-foreground">
              <Switch checked={autoRefresh} onCheckedChange={setAutoRefresh} />
              <span className="whitespace-nowrap">{copy.realtimeRefresh}</span>
            </label>
            {autoRefresh ? (
              <div className="flex h-7 items-center gap-1.5 rounded-md border border-border/70 bg-muted/40 px-2 text-xs text-muted-foreground">
      ...
      <div className="panel-body flex min-h-0 flex-1 flex-col gap-3 overflow-hidden">
        ...
        <div className="min-h-0 flex-1 overflow-auto rounded-lg border border-border/80 bg-background/45">
          ...
          {items.length === 0 ? (
            <div className="grid min-h-56 place-items-center px-4 text-center text-sm text-muted-foreground">
              {isLoading ? (
